...
class PCHeader extends React.Component {
    ...
    render() {
        ...
        const userCenter = () => {
            return (<Menu.Item key="logout" class="register">
        ...
        console.log("the userCenter is ****************" + JSON.stringify(userCenter().toString()));
        const userRegister = () => {
            return (<Menu.Item key="register" class="register">
                <Icon type="appstore"/>注册/登录
            </Menu.Item>);
        }
        console.log("the state haslogined is ************" + this.state.hasLogined);
        const userShow = ()=>{
        ...
        console.log("the pc_header.js of userShow is  ***************" + userShow());
